...
namespace {
    ...
    CharacterAnimationSet makeSet(const Frames4& idle, const WalkSet& walk, const Frames12& win = {}, const Frames12& dead = {}) {
        ...
        case CharacterSpriteVariant::Player:
            return makeSet(
                ...
                Frames12{
                    ...
                    rect(71, 160), rect(88, 160), rect(105, 160), rect(105, 160),
                    rect(105, 160), rect(105, 160), rect(105, 160), rect(105, 160)
                });
...
void CharacterView::draw(sf::RenderWindow& window, const Camera& camera) {
    ...
    const sf::IntRect frame = won
    ? animationSet.win[frameIndex]
    : dead
        ? animationSet.dead[frameIndex]
        : model->isMoving()
